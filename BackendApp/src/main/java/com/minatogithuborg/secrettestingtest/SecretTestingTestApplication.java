package com.minatogithuborg.secrettestingtest;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborg.secrettestingtest"})
@EnableCaching
...
public class SecretTestingTestApplication {

	public static void main(String[] args) {
		SpringApplication.run(SecretTestingTestApplication.class, args);
	}
